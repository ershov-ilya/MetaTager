...
$modx->log(modX::LOG_LEVEL_INFO,'Упаковано в категориях = '); flush();
...
if (!is_array($chunks)) {
    ...
    $modx->log(modX::LOG_LEVEL_INFO,'Упаковано в чанках = '.count($chunks));
}
unset($chunks);
...
$modx->log(modX::LOG_LEVEL_INFO,'Упаковано атрибутов = '); flush();

$modx->log(modX::LOG_LEVEL_INFO,'Упаковка...'); flush();
$builder->pack();
