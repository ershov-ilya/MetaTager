...
$snippet->fromArray(array(
    ...
    'snippet' => getSnippetContent($sources['source_core'].'/elements/snippets/get.php'),
),'',true,true);
$snippets[] = $snippet;
...
$snippet->fromArray(array(
    ...
    'snippet' => getSnippetContent($sources['source_core'].'/elements/snippets/parent.php'),
),'',true,true);
$snippets[] = $snippet;
...
$snippet->fromArray(array(
    ...
    'snippet' => getSnippetContent($sources['source_core'].'/elements/snippets/title.php'),
),'',true,true);
$snippets[] = $snippet;
